    ...
    private void showSavePaintingConfirmationDialog(){
        ...
        saveDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface dialog, int which){
                ...
                //just give the permission first then it works fine and save the file in the gallery local
                //storage
                ...
                if(imgSaved!=null){
                    ...
                    Toast unsavedToast = Toast.makeText(getApplicationContext(),
                            "Oops! Image could not be saved. Please grant the storage permission", Toast.LENGTH_SHORT);
                    unsavedToast.show();
                }
